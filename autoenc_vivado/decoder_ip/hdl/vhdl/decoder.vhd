...
architecture behav of decoder is 
    ...
    signal call_ret3_reg_310_3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_81_1_fu_163_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_81_1_reg_332 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal tmp_81_2_fu_173_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_81_2_reg_337 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_compute_layer_0_0_0_s_fu_60_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_60_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_60_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_60_ap_return_3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_60_ap_ce : STD_LOGIC;
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_compute_layer_0_0_0_1_fu_68_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_1_fu_68_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_1_fu_68_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_1_fu_68_ap_return_3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_1_fu_68_ap_ce : STD_LOGIC;
    signal call_ret1_relu_fu_74_ap_ready : STD_LOGIC;
    signal call_ret1_relu_fu_74_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_74_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_74_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_74_ap_return_3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_s_29_fu_197_p3 : STD_LOGIC_VECTOR (25 downto 0);
    signal tmp_35_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_84_1_fu_219_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_84_2_fu_233_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_36_fu_247_p3 : STD_LOGIC_VECTOR (24 downto 0);
    signal tmp_50_cast_fu_239_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_49_cast_fu_225_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_48_cast_fu_211_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_160_fu_254_p5 : STD_LOGIC_VECTOR (120 downto 0);
...
begin
    ...
    grp_compute_layer_0_0_0_s_fu_60 : component compute_layer_0_0_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_compute_layer_0_0_0_1_fu_68 : component compute_layer_0_0_0_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    call_ret1_relu_fu_74 : component relu
    port map (
    ...
    ap_return <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_160_fu_254_p5),128));

    grp_compute_layer_0_0_0_1_fu_68_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
            grp_compute_layer_0_0_0_1_fu_68_ap_ce <= ap_const_logic_1;
        else 
            grp_compute_layer_0_0_0_1_fu_68_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_compute_layer_0_0_0_s_fu_60_ap_ce_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            grp_compute_layer_0_0_0_s_fu_60_ap_ce <= ap_const_logic_1;
        else 
            grp_compute_layer_0_0_0_s_fu_60_ap_ce <= ap_const_logic_0;
        end if; 
    end process;
    ...
    logits3_V_2_0_logits_fu_167_p3 <= 
        logits3_2_V_reg_315 when (tmp_81_1_fu_163_p2(0) = '1') else 
    ...
    p_s_29_fu_197_p3 <= 
        ...
        p_cast_cast_fu_179_p3;
    p_s_fu_186_p3 <= 
        ap_const_lv26_3000000 when (tmp_81_2_reg_337(0) = '1') else 
        ap_const_lv26_2000000;
    tmp_160_fu_254_p5 <= (((tmp_36_fu_247_p3 & tmp_50_cast_fu_239_p3) & tmp_49_cast_fu_225_p3) & tmp_48_cast_fu_211_p3);
    tmp_35_fu_205_p2 <= "1" when (p_s_29_fu_197_p3 = ap_const_lv26_0) else "0";
    tmp_36_fu_247_p3 <= 
        ap_const_lv25_1000000 when (tmp_81_2_reg_337(0) = '1') else 
        ap_const_lv25_0;
    tmp_48_cast_fu_211_p3 <= 
        ap_const_lv32_1000000 when (tmp_35_fu_205_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_49_cast_fu_225_p3 <= 
        ap_const_lv32_1000000 when (tmp_84_1_fu_219_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_50_cast_fu_239_p3 <= 
        ap_const_lv32_1000000 when (tmp_84_2_fu_233_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_81_1_fu_163_p2 <= "1" when (signed(logits3_2_V_reg_315) > signed(logits3_V_1_0_logits_reg_326)) else "0";
    tmp_81_2_fu_173_p2 <= "1" when (signed(call_ret3_reg_310_3) > signed(logits3_V_2_0_logits_fu_167_p3)) else "0";
    tmp_84_1_fu_219_p2 <= "1" when (p_s_29_fu_197_p3 = ap_const_lv26_1000000) else "0";
    tmp_84_2_fu_233_p2 <= "1" when (p_s_29_fu_197_p3 = ap_const_lv26_2000000) else "0";
    tmp_fu_193_p2 <= (tmp_81_2_reg_337 or tmp_81_1_reg_332);
