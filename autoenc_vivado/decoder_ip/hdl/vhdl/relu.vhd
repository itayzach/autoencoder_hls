...
architecture behav of relu is 
    ...
    signal tmp_30_fu_54_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_115_fu_60_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal res_0_V_write_assig_fu_64_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_30_1_fu_76_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_116_fu_82_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal res_1_V_write_assig_fu_86_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_30_2_fu_98_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_117_fu_104_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal res_2_V_write_assig_fu_108_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_30_3_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_118_fu_126_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    res_0_V_write_assig_fu_64_p3 <= 
        tmp_115_fu_60_p1 when (tmp_30_fu_54_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    res_1_V_write_assig_fu_86_p3 <= 
        tmp_116_fu_82_p1 when (tmp_30_1_fu_76_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    res_2_V_write_assig_fu_108_p3 <= 
        tmp_117_fu_104_p1 when (tmp_30_2_fu_98_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    res_3_V_write_assig_fu_130_p3 <= 
        tmp_118_fu_126_p1 when (tmp_30_3_fu_120_p2(0) = '1') else 
        ap_const_lv31_0;
    tmp_115_fu_60_p1 <= data_0_V_read(31 - 1 downto 0);
    tmp_116_fu_82_p1 <= data_1_V_read(31 - 1 downto 0);
    tmp_117_fu_104_p1 <= data_2_V_read(31 - 1 downto 0);
    tmp_118_fu_126_p1 <= data_3_V_read(31 - 1 downto 0);
    tmp_30_1_fu_76_p2 <= "1" when (signed(data_1_V_read) > signed(ap_const_lv32_0)) else "0";
    tmp_30_2_fu_98_p2 <= "1" when (signed(data_2_V_read) > signed(ap_const_lv32_0)) else "0";
    tmp_30_3_fu_120_p2 <= "1" when (signed(data_3_V_read) > signed(ap_const_lv32_0)) else "0";
    tmp_30_fu_54_p2 <= "1" when (signed(data_0_V_read) > signed(ap_const_lv32_0)) else "0";
end behav;
