...
reg   [31:0] tmp_36_reg_563;
wire    ap_block_state1_pp0_stage0_iter0;
wire    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_pp0_stage0_11001;
reg   [31:0] tmp_51_0_1_reg_568;
reg   [31:0] tmp_51_0_2_reg_573;
reg   [31:0] tmp_51_0_3_reg_578;
reg   [31:0] tmp_51_1_reg_583;
reg   [31:0] tmp_51_1_1_reg_588;
reg   [31:0] tmp_51_1_2_reg_593;
reg   [31:0] tmp_51_1_3_reg_598;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_ce))) begin
        tmp_36_reg_563 <= {{p_Val2_s_fu_75_p2[55:24]}};
        tmp_51_0_1_reg_568 <= {{p_Val2_0_1_fu_72_p2[55:24]}};
        tmp_51_0_2_reg_573 <= {{p_Val2_0_2_fu_74_p2[55:24]}};
        tmp_51_0_3_reg_578 <= {{p_Val2_0_3_fu_68_p2[55:24]}};
        tmp_51_1_1_reg_588 <= {{p_Val2_1_1_fu_70_p2[55:24]}};
        tmp_51_1_2_reg_593 <= {{p_Val2_1_2_fu_71_p2[55:24]}};
        tmp_51_1_3_reg_598 <= {{p_Val2_1_3_fu_69_p2[55:24]}};
        tmp_51_1_reg_583 <= {{p_Val2_1_fu_73_p2[55:24]}};
    end
end

assign OP1_V_1_cast_fu_451_p1 = $signed(tmp_34_fu_441_p4);

assign OP1_V_cast_fu_393_p1 = $signed(tmp_161_fu_389_p1);
...
assign res_0_V_write_assig_fu_504_p2 = (tmp_36_reg_563 + tmp1_fu_499_p2);

assign res_1_V_write_assig_fu_514_p2 = (tmp_51_0_1_reg_568 + tmp2_fu_509_p2);

assign res_2_V_write_assig_fu_524_p2 = (tmp_51_0_2_reg_573 + tmp3_fu_519_p2);

assign res_3_V_write_assig_fu_534_p2 = (tmp_51_0_3_reg_578 + tmp4_fu_529_p2);

assign tmp1_fu_499_p2 = (32'd27706295 + tmp_51_1_reg_583);

assign tmp2_fu_509_p2 = (32'd23164708 + tmp_51_1_1_reg_588);

assign tmp3_fu_519_p2 = ($signed(32'd4290690985) + $signed(tmp_51_1_2_reg_593));

assign tmp4_fu_529_p2 = (32'd23439908 + tmp_51_1_3_reg_598);

assign tmp_161_fu_389_p1 = data_V_read[31:0];

assign tmp_34_fu_441_p4 = {{data_V_read[63:32]}};
