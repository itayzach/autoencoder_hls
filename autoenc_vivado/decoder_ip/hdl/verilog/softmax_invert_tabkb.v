...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_invert_tabkb_rom (
...
initial begin
    $readmemh("./softmax_invert_tabkb_rom.dat", ram0);
    $readmemh("./softmax_invert_tabkb_rom.dat", ram1);
end
...
softmax_invert_tabkb_rom softmax_invert_tabkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
