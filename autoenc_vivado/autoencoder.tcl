...
xilinx.com:hls:decoder_top:1.0\
xilinx.com:ip:axi_dma:7.1\
xilinx.com:hls:encoder_top:1.0\
"
...
# Hierarchical cell: enc_dec
proc create_hier_cell_enc_dec { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_enc_dec() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: decoder_top, and set properties
  set decoder_top [ create_bd_cell -type ip -vlnv xilinx.com:hls:decoder_top:1.0 decoder_top ]

  # Create instance: enc_dec_dma, and set properties
  set enc_dec_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 enc_dec_dma ]
  ...
  # Create instance: encoder_top, and set properties
  set encoder_top [ create_bd_cell -type ip -vlnv xilinx.com:hls:encoder_top:1.0 encoder_top ]
  ...
  connect_bd_intf_net -intf_net decoder_top_axis_dec_data_out [get_bd_intf_pins decoder_top/axis_dec_data_out] [get_bd_intf_pins enc_dec_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net enc_dec_dma_M_AXIS_MM2S [get_bd_intf_pins enc_dec_dma/M_AXIS_MM2S] [get_bd_intf_pins encoder_top/axis_enc_data_in]
  connect_bd_intf_net -intf_net encoder_top_0_axis_enc_data_out [get_bd_intf_pins decoder_top/axis_dec_data_in] [get_bd_intf_pins encoder_top/axis_enc_data_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins decoder_top/ap_clk] [get_bd_pins enc_dec_dma/m_axi_mm2s_aclk] [get_bd_pins enc_dec_dma/m_axi_s2mm_aclk] [get_bd_pins enc_dec_dma/s_axi_lite_aclk] [get_bd_pins encoder_top/ap_clk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins decoder_top/ap_rst_n] [get_bd_pins enc_dec_dma/axi_resetn] [get_bd_pins encoder_top/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: enc_dec
  create_hier_cell_enc_dec [current_bd_instance .] enc_dec
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins enc_dec/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins enc_dec/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
