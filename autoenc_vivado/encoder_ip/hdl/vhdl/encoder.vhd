...
port (
    ...
    res_V : OUT STD_LOGIC_VECTOR (63 downto 0);
...
architecture behav of encoder is 
    ...
    "encoder,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=8.742000,HLS_SYN_LAT=90,HLS_SYN_TPT=91,HLS_SYN_MEM=0,HLS_SYN_DSP=84,HLS_SYN_FF=17028,HLS_SYN_LUT=18425,HLS_VERSION=2018_2}";
    ...
    signal logits1_0_V_reg_114 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal logits1_1_V_reg_119 : STD_LOGIC_VECTOR (31 downto 0);
    signal logits1_2_V_reg_124 : STD_LOGIC_VECTOR (31 downto 0);
    signal logits1_3_V_reg_129 : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_relu_out_0_V_reg_134 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal layer1_relu_out_1_V_reg_139 : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_relu_out_2_V_reg_144 : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_relu_out_3_V_reg_149 : STD_LOGIC_VECTOR (31 downto 0);
    signal logits2_0_V_reg_154 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal logits2_1_V_reg_159 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_normalization_layer_fu_45_ap_start : STD_LOGIC;
    signal grp_normalization_layer_fu_45_ap_done : STD_LOGIC;
    signal grp_normalization_layer_fu_45_ap_idle : STD_LOGIC;
    signal grp_normalization_layer_fu_45_ap_ready : STD_LOGIC;
    signal grp_normalization_layer_fu_45_ap_return : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_52_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_52_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_52_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_52_ap_return_3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_s_fu_52_ap_ce : STD_LOGIC;
    signal grp_compute_layer_0_0_0_fu_58_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_fu_58_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_compute_layer_0_0_0_fu_58_ap_ce : STD_LOGIC;
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal call_ret1_relu_fu_66_ap_ready : STD_LOGIC;
    signal call_ret1_relu_fu_66_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_66_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_66_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal call_ret1_relu_fu_66_ap_return_3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_normalization_layer_fu_45_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_normalization_layer_fu_45 : component normalization_layer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_normalization_layer_fu_45_ap_start,
        ap_done => grp_normalization_layer_fu_45_ap_done,
        ap_idle => grp_normalization_layer_fu_45_ap_idle,
        ap_ready => grp_normalization_layer_fu_45_ap_ready,
        data_0_V_read => logits2_0_V_reg_154,
        data_1_V_read => logits2_1_V_reg_159,
        ap_return => grp_normalization_layer_fu_45_ap_return);

    grp_compute_layer_0_0_0_s_fu_52 : component compute_layer_0_0_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        data_V_read => data_V,
        ap_return_0 => grp_compute_layer_0_0_0_s_fu_52_ap_return_0,
        ap_return_1 => grp_compute_layer_0_0_0_s_fu_52_ap_return_1,
        ap_return_2 => grp_compute_layer_0_0_0_s_fu_52_ap_return_2,
        ap_return_3 => grp_compute_layer_0_0_0_s_fu_52_ap_return_3,
        ap_ce => grp_compute_layer_0_0_0_s_fu_52_ap_ce);

    grp_compute_layer_0_0_0_fu_58 : component compute_layer_0_0_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        data_0_V_read => layer1_relu_out_0_V_reg_134,
        data_1_V_read => layer1_relu_out_1_V_reg_139,
        data_2_V_read => layer1_relu_out_2_V_reg_144,
        data_3_V_read => layer1_relu_out_3_V_reg_149,
        ap_return_0 => grp_compute_layer_0_0_0_fu_58_ap_return_0,
        ap_return_1 => grp_compute_layer_0_0_0_fu_58_ap_return_1,
        ap_ce => grp_compute_layer_0_0_0_fu_58_ap_ce);

    call_ret1_relu_fu_66 : component relu
    port map (
        ap_ready => call_ret1_relu_fu_66_ap_ready,
        data_0_V_read => logits1_0_V_reg_114,
        data_1_V_read => logits1_1_V_reg_119,
        data_2_V_read => logits1_2_V_reg_124,
        data_3_V_read => logits1_3_V_reg_129,
        ap_return_0 => call_ret1_relu_fu_66_ap_return_0,
        ap_return_1 => call_ret1_relu_fu_66_ap_return_1,
        ap_return_2 => call_ret1_relu_fu_66_ap_return_2,
        ap_return_3 => call_ret1_relu_fu_66_ap_return_3);
    ...
    grp_normalization_layer_fu_45_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_normalization_layer_fu_45_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_NS_fsm_state6) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                    grp_normalization_layer_fu_45_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_normalization_layer_fu_45_ap_ready = ap_const_logic_1)) then 
                    grp_normalization_layer_fu_45_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                layer1_relu_out_0_V_reg_134 <= call_ret1_relu_fu_66_ap_return_0;
                layer1_relu_out_1_V_reg_139 <= call_ret1_relu_fu_66_ap_return_1;
                layer1_relu_out_2_V_reg_144 <= call_ret1_relu_fu_66_ap_return_2;
                layer1_relu_out_3_V_reg_149 <= call_ret1_relu_fu_66_ap_return_3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                logits1_0_V_reg_114 <= grp_compute_layer_0_0_0_s_fu_52_ap_return_0;
                logits1_1_V_reg_119 <= grp_compute_layer_0_0_0_s_fu_52_ap_return_1;
                logits1_2_V_reg_124 <= grp_compute_layer_0_0_0_s_fu_52_ap_return_2;
                logits1_3_V_reg_129 <= grp_compute_layer_0_0_0_s_fu_52_ap_return_3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                logits2_0_V_reg_154 <= grp_compute_layer_0_0_0_fu_58_ap_return_0;
                logits2_1_V_reg_159 <= grp_compute_layer_0_0_0_fu_58_ap_return_1;
            end if;
        end if;
    end process;
    ...
    grp_compute_layer_0_0_0_fu_58_ap_ce_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            grp_compute_layer_0_0_0_fu_58_ap_ce <= ap_const_logic_1;
        else 
            grp_compute_layer_0_0_0_fu_58_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_compute_layer_0_0_0_s_fu_52_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            grp_compute_layer_0_0_0_s_fu_52_ap_ce <= ap_const_logic_1;
        else 
            grp_compute_layer_0_0_0_s_fu_52_ap_ce <= ap_const_logic_0;
        end if; 
    end process;

    grp_normalization_layer_fu_45_ap_start <= grp_normalization_layer_fu_45_ap_start_reg;
    res_V <= grp_normalization_layer_fu_45_ap_return;

    res_V_ap_vld_assign_proc : process(ap_CS_fsm_state91)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state91)) then 
