...
(* CORE_GENERATION_INFO="encoder,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=8.742000,HLS_SYN_LAT=90,HLS_SYN_TPT=91,HLS_SYN_MEM=0,HLS_SYN_DSP=84,HLS_SYN_FF=17028,HLS_SYN_LUT=18425,HLS_VERSION=2018_2}" *)
...
reg   [31:0] logits1_0_V_reg_114;
wire    ap_CS_fsm_state2;
reg   [31:0] logits1_1_V_reg_119;
reg   [31:0] logits1_2_V_reg_124;
reg   [31:0] logits1_3_V_reg_129;
reg   [31:0] layer1_relu_out_0_V_reg_134;
wire    ap_CS_fsm_state3;
reg   [31:0] layer1_relu_out_1_V_reg_139;
reg   [31:0] layer1_relu_out_2_V_reg_144;
reg   [31:0] layer1_relu_out_3_V_reg_149;
reg   [31:0] logits2_0_V_reg_154;
wire    ap_CS_fsm_state5;
reg   [31:0] logits2_1_V_reg_159;
wire    grp_normalization_layer_fu_45_ap_start;
wire    grp_normalization_layer_fu_45_ap_done;
wire    grp_normalization_layer_fu_45_ap_idle;
wire    grp_normalization_layer_fu_45_ap_ready;
wire   [63:0] grp_normalization_layer_fu_45_ap_return;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_52_ap_return_0;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_52_ap_return_1;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_52_ap_return_2;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_52_ap_return_3;
reg    grp_compute_layer_0_0_0_s_fu_52_ap_ce;
wire   [31:0] grp_compute_layer_0_0_0_fu_58_ap_return_0;
wire   [31:0] grp_compute_layer_0_0_0_fu_58_ap_return_1;
reg    grp_compute_layer_0_0_0_fu_58_ap_ce;
wire    ap_CS_fsm_state4;
wire    call_ret1_relu_fu_66_ap_ready;
wire   [31:0] call_ret1_relu_fu_66_ap_return_0;
wire   [31:0] call_ret1_relu_fu_66_ap_return_1;
wire   [31:0] call_ret1_relu_fu_66_ap_return_2;
wire   [31:0] call_ret1_relu_fu_66_ap_return_3;
reg    grp_normalization_layer_fu_45_ap_start_reg;
reg   [90:0] ap_NS_fsm;
...
initial begin
#0 ap_CS_fsm = 91'd1;
#0 grp_normalization_layer_fu_45_ap_start_reg = 1'b0;
end

normalization_layer grp_normalization_layer_fu_45(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
compute_layer_0_0_0_s grp_compute_layer_0_0_0_s_fu_52(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .data_V_read(data_V),
...
compute_layer_0_0_0 grp_compute_layer_0_0_0_fu_58(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_normalization_layer_fu_45_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_NS_fsm_state6) & (1'b1 == ap_CS_fsm_state5))) begin
            grp_normalization_layer_fu_45_ap_start_reg <= 1'b1;
        end else if ((grp_normalization_layer_fu_45_ap_ready == 1'b1)) begin
            grp_normalization_layer_fu_45_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state5))) begin
        grp_compute_layer_0_0_0_fu_58_ap_ce = 1'b1;
    end else begin
        grp_compute_layer_0_0_0_fu_58_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
        grp_compute_layer_0_0_0_s_fu_52_ap_ce = 1'b1;
    end else begin
        grp_compute_layer_0_0_0_s_fu_52_ap_ce = 1'b0;
    end
end
...
assign grp_normalization_layer_fu_45_ap_start = grp_normalization_layer_fu_45_ap_start_reg;

assign res_V = grp_normalization_layer_fu_45_ap_return;
