...
begin
    ...
    res_1_V_write_assig_fu_86_p3 <= 
        tmp_205_fu_82_p1 when (tmp_96_1_fu_76_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    res_2_V_write_assig_fu_108_p3 <= 
        tmp_206_fu_104_p1 when (tmp_96_2_fu_98_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    res_3_V_write_assig_fu_130_p3 <= 
        tmp_207_fu_126_p1 when (tmp_96_3_fu_120_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    tmp_96_1_fu_76_p2 <= "1" when (signed(data_1_V_read) > signed(ap_const_lv32_0)) else "0";
    tmp_96_2_fu_98_p2 <= "1" when (signed(data_2_V_read) > signed(ap_const_lv32_0)) else "0";
    tmp_96_3_fu_120_p2 <= "1" when (signed(data_3_V_read) > signed(ap_const_lv32_0)) else "0";
