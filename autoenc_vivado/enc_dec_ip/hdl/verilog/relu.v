...
assign res_1_V_write_assig_fu_86_p3 = ((tmp_95_1_fu_76_p2[0:0] === 1'b1) ? tmp_209_fu_82_p1 : 31'd0);

assign res_2_V_write_assig_3_fu_116_p1 = res_2_V_write_assig_fu_108_p3;

assign res_2_V_write_assig_fu_108_p3 = ((tmp_95_2_fu_98_p2[0:0] === 1'b1) ? tmp_210_fu_104_p1 : 31'd0);

assign res_3_V_write_assig_3_fu_138_p1 = res_3_V_write_assig_fu_130_p3;

assign res_3_V_write_assig_fu_130_p3 = ((tmp_95_3_fu_120_p2[0:0] === 1'b1) ? tmp_211_fu_126_p1 : 31'd0);
...
assign tmp_95_1_fu_76_p2 = (($signed(data_1_V_read) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign tmp_95_2_fu_98_p2 = (($signed(data_2_V_read) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign tmp_95_3_fu_120_p2 = (($signed(data_3_V_read) > $signed(32'd0)) ? 1'b1 : 1'b0);
