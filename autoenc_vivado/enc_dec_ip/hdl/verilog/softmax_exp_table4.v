...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_exp_table4_rom (
...
initial begin
    $readmemh("./softmax_exp_table4_rom.dat", ram0);
    $readmemh("./softmax_exp_table4_rom.dat", ram1);
    $readmemh("./softmax_exp_table4_rom.dat", ram2);
    $readmemh("./softmax_exp_table4_rom.dat", ram3);
    $readmemh("./softmax_exp_table4_rom.dat", ram4);
    $readmemh("./softmax_exp_table4_rom.dat", ram5);
end
...
softmax_exp_table4_rom softmax_exp_table4_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
