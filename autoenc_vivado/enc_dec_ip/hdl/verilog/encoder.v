...
wire    grp_compute_layer_0_0_0_s_fu_40_data_V_TDATA_blk_n;
reg   [31:0] logits1_0_V_reg_102;
wire    ap_CS_fsm_state3;
reg   [31:0] logits1_1_V_reg_107;
reg   [31:0] logits1_2_V_reg_112;
reg   [31:0] logits1_3_V_reg_117;
reg   [31:0] layer1_relu_out_0_V_reg_122;
wire    ap_CS_fsm_state4;
reg   [31:0] layer1_relu_out_1_V_reg_127;
reg   [31:0] layer1_relu_out_2_V_reg_132;
reg   [31:0] layer1_relu_out_3_V_reg_137;
reg   [31:0] logits2_0_V_reg_142;
wire    ap_CS_fsm_state6;
reg   [31:0] logits2_1_V_reg_147;
wire    grp_normalization_layer_fu_34_ap_start;
wire    grp_normalization_layer_fu_34_ap_done;
wire    grp_normalization_layer_fu_34_ap_idle;
wire    grp_normalization_layer_fu_34_ap_ready;
reg    grp_normalization_layer_fu_34_ap_ce;
wire   [63:0] grp_normalization_layer_fu_34_ap_return;
...
reg    grp_compute_layer_0_0_0_s_fu_40_ap_start;
wire    grp_compute_layer_0_0_0_s_fu_40_ap_done;
wire    grp_compute_layer_0_0_0_s_fu_40_ap_idle;
wire    grp_compute_layer_0_0_0_s_fu_40_ap_ready;
reg    grp_compute_layer_0_0_0_s_fu_40_ap_ce;
wire    grp_compute_layer_0_0_0_s_fu_40_data_V_TREADY;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_40_ap_return_0;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_40_ap_return_1;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_40_ap_return_2;
wire   [31:0] grp_compute_layer_0_0_0_s_fu_40_ap_return_3;
reg    ap_block_state1;
wire   [31:0] grp_compute_layer_0_0_0_fu_46_ap_return_0;
wire   [31:0] grp_compute_layer_0_0_0_fu_46_ap_return_1;
reg    grp_compute_layer_0_0_0_fu_46_ap_ce;
wire    call_ret1_relu_fu_54_ap_ready;
wire   [31:0] call_ret1_relu_fu_54_ap_return_0;
wire   [31:0] call_ret1_relu_fu_54_ap_return_1;
wire   [31:0] call_ret1_relu_fu_54_ap_return_2;
wire   [31:0] call_ret1_relu_fu_54_ap_return_3;
reg    grp_normalization_layer_fu_34_ap_start_reg;
reg   [90:0] ap_NS_fsm;
...
initial begin
#0 ap_CS_fsm = 91'd1;
#0 grp_normalization_layer_fu_34_ap_start_reg = 1'b0;
end

normalization_layer grp_normalization_layer_fu_34(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
compute_layer_0_0_0_s grp_compute_layer_0_0_0_s_fu_40(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
compute_layer_0_0_0 grp_compute_layer_0_0_0_fu_46(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_normalization_layer_fu_34_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_NS_fsm_state7) & (1'b1 == ap_CS_fsm_state6))) begin
            grp_normalization_layer_fu_34_ap_start_reg <= 1'b1;
        end else if ((grp_normalization_layer_fu_34_ap_ready == 1'b1)) begin
            grp_normalization_layer_fu_34_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state91) & (1'b1 == ap_ce)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_ce) & ((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state6)))) begin
        grp_compute_layer_0_0_0_fu_46_ap_ce = 1'b1;
    end else begin
        grp_compute_layer_0_0_0_fu_46_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_ce) & ((1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state3) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))))) begin
        grp_compute_layer_0_0_0_s_fu_40_ap_ce = 1'b1;
    end else begin
        grp_compute_layer_0_0_0_s_fu_40_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (1'b1 == ap_ce))) begin
        grp_compute_layer_0_0_0_s_fu_40_ap_start = 1'b1;
    end else begin
        grp_compute_layer_0_0_0_s_fu_40_ap_start = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state1) | (1'b0 == ap_ce))) begin
        grp_normalization_layer_fu_34_ap_ce = 1'b0;
    end else begin
        grp_normalization_layer_fu_34_ap_ce = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_start == 1'b0) | (grp_compute_layer_0_0_0_s_fu_40_data_V_TDATA_blk_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (1'b1 == ap_ce))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (grp_compute_layer_0_0_0_s_fu_40_data_V_TDATA_blk_n == 1'b0));
end

assign ap_return = grp_normalization_layer_fu_34_ap_return;

assign grp_normalization_layer_fu_34_ap_start = grp_normalization_layer_fu_34_ap_start_reg;
