...
wire    ap_block_state89_pp0_stage8_iter8_ignore_call12;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if (((ap_enable_reg_pp0_iter8 == 1'b0) & (1'b0 == ap_block_pp0_stage4_subdone) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
            ap_enable_reg_pp0_iter9 <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter9 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4)) | ((1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign ap_block_state89_pp0_stage8_iter8_ignore_call12 = ~(1'b1 == 1'b1);
...
assign ap_return = {{tmp_115_1_fu_163_p4}, {tmp_97_reg_253}};

assign div_res_0_V_fu_127_p1 = tmp_96_reg_238[31:0];

assign div_res_1_V_fu_150_p1 = tmp_112_1_reg_243[31:0];
...
assign grp_fu_122_p0 = {{data_1_V_read_4_reg_191_pp0_iter2_reg}, {24'd0}};
...
assign tmp_115_1_fu_163_p4 = {{grp_fu_157_p2[55:24]}};
