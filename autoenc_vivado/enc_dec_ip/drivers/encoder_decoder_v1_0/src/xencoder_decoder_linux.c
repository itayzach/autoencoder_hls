...
typedef struct {
    ...
    XEncoder_decoder_uio_map maps[ MAX_UIO_MAPS ];
} XEncoder_decoder_uio_info;

/***************** Variable Definitions **************************************/
static XEncoder_decoder_uio_info uio_info;
...
static int uio_info_read_name(XEncoder_decoder_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XEncoder_decoder_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XEncoder_decoder_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XEncoder_decoder_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XEncoder_decoder_Initialize(XEncoder_decoder *InstancePtr, const char* InstanceName) {
	XEncoder_decoder_uio_info *InfoPtr = &uio_info;
